...
<span style="font-size: 15px !important; color: #555;">In the paper, we implemented a Bayes factor calculator for the Bayesian MANOVA using the BRMS package in R and made a <a href="http://cocoanlab.skku.edu/bayes_factor_bayesian_manova/">website</a> to provide a web-based service of the analysis. See the latest version of the <a href="https://www.biorxiv.org/content/10.1101/514521v2">paper</a> and <a href="https://github.com/cocoanlab/falsepositiveneuroimaging">code</a>.</span>
